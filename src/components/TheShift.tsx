        ...
        <section className="relative z-10 py-24 px-6 md:px-12 bg-white">
            <div className="max-w-7xl mx-auto">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                    ...
                    >
                        <h2 className="text-4xl md:text-5xl font-bold font-display leading-tight mb-6 text-slate-900">
                            The Shift in <br />
                            <span className="text-transparent bg-clip-text bg-gradient-to-r from-slate-900 to-slate-500">Customer Expectations</span>
                        </h2>
                    ...
                    <div className="grid gap-6">
                        {valueProps.map((prop, index) => (
                            <motion.div
                                ...
                                className="p-6 rounded-2xl bg-slate-50 border border-slate-100 hover:border-black/20 transition-colors group shadow-sm hover:shadow-md"
                            >
                                <div className="flex items-start gap-4">
                                    <div className="mt-1 w-5 h-5 rounded-full border border-black/10 flex items-center justify-center shrink-0">
                                        <div className="w-2 h-2 rounded-full bg-black animate-pulse" />
                                    </div>
                                    <div>
                                        <h3 className="text-xl font-bold mb-2 text-slate-900 group-hover:text-black transition-colors">{prop.title}</h3>
