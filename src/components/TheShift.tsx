...
const TheShift: React.FC = () => {
    ...
    return (
        <section className="relative z-10 py-24 px-6 md:px-12 bg-black/50 backdrop-blur-sm border-y border-white/5">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                    ...
                    >
                        <h2 className="text-3xl md:text-5xl font-bold font-display leading-tight mb-6">
                            The Shift in <br />
                            <span className="text-[#00eeff]">Customer Expectations</span>
                        </h2>
                    ...
                    <div className="grid gap-6">
                        {valueProps.map((prop, index) => (
                            <motion.div
                                ...
                                className="p-6 rounded-2xl bg-white/5 border border-white/10 hover:border-[#00eeff]/30 transition-colors group"
                            >
                                <div className="flex items-start gap-4">
                                    <div className="mt-1 w-5 h-5 rounded-full border border-[#00eeff] flex items-center justify-center shrink-0">
                                        <div className="w-2 h-2 rounded-full bg-[#00eeff] animate-pulse" />
                                    </div>
                                    <div>
                                        <h3 className="text-xl font-bold mb-2 group-hover:text-[#00eeff] transition-colors">{prop.title}</h3>
