    ...
    return (
        <main className="relative z-10 flex flex-col items-center justify-center min-h-[90vh] px-6 text-center pt-20">
            ...
            >
                ...
                <span className="text-xs font-medium tracking-wide uppercase text-gray-300">Future of Enterprise AI</span>
            </motion.div>
            ...
            >
                ...
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-white via-gray-200 to-gray-500">For Your Business.</span>
            </motion.h1>
            ...
            >
                Stop forcing your workflows to fit rigid tools. We build custom AI automation
                and intelligence systems that scale with your operations and drive measurable ROI.
            </motion.p>
            ...
            <motion.div
                ...
                className="mt-20 text-xs font-medium text-gray-500 uppercase tracking-widest"
            >
